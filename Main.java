...
// Sources Used:     http://www.java2s.com/Tutorials/Java/JavaFX/0350
//							__JavaFX_ScrollPane.htm
//
///////////////////////////////////////////////////////////////////////////////
                     ...
                     if(i == rounds.length-1) {
                         b1.setOnAction(event -> {
                                ...
                                if(currentRound > 0) {
                                    ...
                                    if(bracket.getRound(currentRound-1).get(0).getLoserScore() >= bracket.getRound(currentRound-1).get(1).getLoserScore()) {
                                        lbl_thirdPlace.setText("Third Place: " + bracket.getRound(currentRound-1).get(0).getLoser().getName());
                                    } else {
                                        lbl_thirdPlace.setText("Third Place: " + bracket.getRound(currentRound-1).get(1).getLoser().getName());
                                    }
                                }
